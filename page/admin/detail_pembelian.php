...
<table class="table table-bordered">
		<th style=" background: #E6E6FA; "><center>Nama Minuman</center></th>
	...
	<tr>
		<td><center><?php $data=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from drink where id_drink='$c[id_drink]'"));$nama=$data['judul']; echo $nama; ?></center></td>
