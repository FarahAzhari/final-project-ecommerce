...
<head>
    ...
    <title>Sign Up POP - Soda Pop</title>
            ...
            <div class="row">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        <form action="cekdaftar.php" method="post" style="width: 23rem;">
                            ...
                            <button type="submit" class="btn btn-lg btn-secondary mb-4 pt-1">Sign Up</button>
